...
export const RecoveryLinkSent: React.FC = () => {
  ...
  return (
    <div id="page-login" className="grid grid-cols-1 md:grid-cols-12 min-h-screen bg-white">
      ...
      <div className="col-span-12 md:col-span-4 items-center justify-center px-3.5  bg-white">
              ...
              <div className="flex justify-between mb-1">
                {otp.map((digit, index) => (
                  <input
                    ...
                    // onPaste={handlePaste}
                    className="w-12 h-12 border border-[#d8d6de] rounded text-center text-lg focus:border-[#7367f0] focus:ring-1 focus:ring-[#7367f0] outline-none"
                  />
                ))}
              </div>
                {state?.errorEmailTxt && (
